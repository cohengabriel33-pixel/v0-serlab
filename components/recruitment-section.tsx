        ...
        {activeTab === "empresas" ? (
          <div id="para-empresas" role="tabpanel" aria-label="Para empresas">
            <div className="mb-12 text-center">
              ...
              <a href="mailto:info@serlabconsultora.com" target="_blank" rel="noopener noreferrer" className="mt-7 inline-flex rounded-sm bg-primary px-6 py-3 text-sm font-semibold uppercase tracking-wider text-primary-foreground transition-opacity hover:opacity-90">Consultar por búsquedas</a>
            </div>
