    ...
    <section id="servicios" className="bg-foreground">
      ...
      <div className="mx-auto grid max-w-6xl gap-4 px-4 pb-16 sm:grid-cols-2 md:grid-cols-3">
        {panels.map((panel) => (
          ...
          >
            <div
              className="absolute inset-0 bg-no-repeat transition-all duration-500 group-hover:scale-105 group-hover:opacity-30"
              style={{
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-foreground/70 to-transparent p-5 transition-opacity duration-500 group-hover:opacity-0">
            ...
            <div className="absolute inset-0 flex flex-col items-start justify-end bg-foreground/70 p-6 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
              <p className="translate-y-3 font-heading text-2xl font-medium text-background opacity-0 transition-all duration-500 delay-100 group-hover:translate-y-0 group-hover:opacity-100">
                {panel.title} <span className="italic text-accent">{panel.subtitle}</span>
              </p>
              <p className="mt-2 max-w-[18rem] translate-y-3 text-sm leading-relaxed text-background/90 opacity-0 transition-all duration-500 delay-150 group-hover:translate-y-0 group-hover:opacity-100">
